...
public class AiKucuk : MonoBehaviour
{
    Transform target;
    GameObject Target;
    ...
    {
        //Debug.Log("Parene girdik");
        //Çalışıyor buraya damage yap bize vurduğunda buradna damage yiyecez
    }
    void AttackSystem()
    {
        //canı azaldığında attack 2 de gelsin.
        //kafana gre ayarla ya sırayla yapsun ya da rasatgele yapsın attakcları
    }
}
